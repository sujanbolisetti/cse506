...
static struct Command commands[] = {
	...
	{"si","Single Stepping",mon_singlestep}// single_stepping}
};
...
void
single_stepping(int argc, char **argv,struct Trapframe *tf)
{
	 struct Ripdebuginfo info={"<unknown>",0,"<unknown>",9};
	 uint64_t rip;
	 read_rip(rip);
...
monitor(struct Trapframe *tf)
{
	...
	//cprintf("came inside the monitor\n");
